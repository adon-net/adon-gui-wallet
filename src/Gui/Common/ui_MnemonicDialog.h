...
public:
    ...
    void retranslateUi(QDialog *MnemonicDialog)
    {
        ...
        m_languageLabel->setText(QApplication::translate("MnemonicDialog", "Select language", nullptr));
        m_okButton->setText(QApplication::translate("MnemonicDialog", "OK", nullptr));
    } // retranslateUi
