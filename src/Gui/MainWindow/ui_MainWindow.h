...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/adon"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutAdonAction = new QAction(MainWindow);
        m_aboutAdonAction->setObjectName(QStringLiteral("m_aboutAdonAction"));
        m_aboutAdonAction->setEnabled(true);
        ...
        m_showQrCodeButton = new WalletGui::WalletTinyLinkLikeButton(m_notEncryptedFrame);
        m_showQrCodeButton->setObjectName(QStringLiteral("m_showQrCodeButton"));
        QSizePolicy sizePolicy2(QSizePolicy::Minimum, QSizePolicy::Fixed);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(m_showQrCodeButton->sizePolicy().hasHeightForWidth());
        m_showQrCodeButton->setSizePolicy(sizePolicy2);
        ...
        horizontalLayout_4->addWidget(m_showQrCodeButton);
        ...
        sizePolicy2.setHeightForWidth(m_receiveButton->sizePolicy().hasHeightForWidth());
        m_receiveButton->setSizePolicy(sizePolicy2);
        ...
        menuHelp->addAction(m_aboutAdonAction);
        ...
        QObject::connect(m_aboutAdonAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutAdonAction->setText(QApplication::translate("MainWindow", "About Adon", nullptr));
        ...
        m_createPaymentRequestAction->setText(QApplication::translate("MainWindow", "Request", nullptr));
        m_openPaymentRequestAction->setText(QApplication::translate("MainWindow", "Open", nullptr));
        ...
        m_importSeedAction->setText(QApplication::translate("MainWindow", "Import Mnemonics", nullptr));
        m_showSeedAction->setText(QApplication::translate("MainWindow", "Show Mnemonics", nullptr));
